  ...
  _createClass(DragSortableList, [{
    ...
    value: function _dragMove(event) {
      ...
      if (draggedEl && state.dragging) {
        ...
        state.dragging.top = target.offsetTop - parseInt(getStyle(target, 'margin-top'), 10) - (target.parentElement && target.parentElement.parentElement ? target.parentElement.parentElement.scrollTop : 0);
