...
var DragSortableList = function (_React$Component) {
  ...
  _createClass(DragSortableList, [{
    ...
    value: function render() {
      ...
      return _react2.default.createElement('div', { id: this.ref, className: 'List', ref: this.ref }, itemsNodes);
    }
  }, {
    key: '_displayItem',
    value: function _displayItem(item, type) {
      ...
      if (type === 'normal') {
        return _react2.default.createElement('div', { ref: this.ref + key, style: style, 'data-id': id, 'data-rank': rank, key: key, className: classNames }, content);
      }
      ...
      if (type === 'dragged') {
        ...
        classNames += ' dragged';
        return _react2.default.createElement('div', { ref: this.ref + 'dragged', 'data-id': id, key: key, className: classNames, style: style }, content);
      }
      ...
      if (type === 'placeholder') {
        ...
        return _react2.default.createElement('div', { ref: this.ref + 'placeholder', key: 'placeholder', className: classNames, style: style }, placeholder);
      }
    }
  }, {
    key: '_dragMove',
