...
var DragSortableList = function (_React$Component) {
  ...
  function DragSortableList(props) {
    ...
    _this.ref = linkRef(_this, 'List' + id); // generate unique ref
    _this.refId = 'List' + id; // generate unique ref
    // _this.id = _this.refId;
  ...
  _createClass(DragSortableList, [{
    ...
    value: function componentDidMount() {
      var draggableChildrenSelector = '#' + this.refId + '> .draggable';
    ...
    value: function componentDidUpdate(prevProps, prevState) {
      ...
      if (moveTransitionDuration) {
        var placeholderEl = this.refs[this.refId + "placeholder"];
    ...
    value: function render() {
      ...
      return _react2.default.createElement('div', { id: this.refId, className: 'List', ref: this.ref }, itemsNodes);
    }
  }, {
    key: '_displayItem',
    value: function _displayItem(item, type) {
      ...
      if (type === 'normal') {
        return _react2.default.createElement('div', { ref: linkRef(this, this.refId + key), style: style, 'data-id': id, 'data-rank': rank, key: key, className: classNames }, content);
      }
      ...
      if (type === 'dragged') {
        ...
        classNames += ' dragged';
        return _react2.default.createElement('div', { ref: linkRef(this, this.refId + 'dragged'), 'data-id': id, key: key, className: classNames, style: style }, content);
      }
      ...
      if (type === 'placeholder') {
        ...
        return _react2.default.createElement('div', { ref: linkRef(this, this.refId + 'placeholder'), key: 'placeholder', className: classNames, style: style }, placeholder);
      }
    }
  }, {
    key: '_dragMove',
    value: function _dragMove(event) {
      ...
      if (target.parentElement && target.parentElement.parentElement && target.parentElement.parentElement.scrollTop) {
           topOffset = target.parentElement.parentElement.scrollTop;
      }
      var draggedEl = this.refs[this.refId + 'dragged'];
      ...
      if (draggedEl && state.dragging) {
        ...
        draggedEl.style.top = (state.dragging.top + topOffset) + 'px';
